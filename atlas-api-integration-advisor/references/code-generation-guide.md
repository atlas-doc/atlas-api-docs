...
{% hint style="warning" %}
**Critical rule:** Never use the same base URL for `search.do` and transaction APIs in production. Always verify with ATRIP → Profile → My Profile → Company Information.
{% endhint %}
